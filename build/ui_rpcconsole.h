...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "mmocoin - Debug window", nullptr));
        label_9->setText(QApplication::translate("RPCConsole", "mmocoin Core", nullptr));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the mmocoin debug log file from the current data directory. This can take a few seconds for large log files.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the mmocoin-Qt help message to get a list with possible mmocoin command-line options.", nullptr));
#endif // QT_NO_TOOLTIP

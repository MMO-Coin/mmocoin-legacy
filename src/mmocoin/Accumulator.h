 ...
 * @file       Accumulator.h
 *
 * @brief      Accumulator and AccumulatorWitness classes for the MMOCoin library.
 *
...
public:
	 ...
	 * @throw      MMOCoin exception in case of invalid parameters
	 **/
	 ...
	 *
	 * @throw		MMOCoin exception if the coin is not valid.
	 *
	 **/
	...
	//  * @throw  A MMOCoinException if the accumulator value is invalid.
	//  */

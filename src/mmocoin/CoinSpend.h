 ...
 * @file       CoinSpend.h
 *
 * @brief      CoinSpend class for the MMOCoin library.
 *
...
/** The complete proof needed to spend a mmocoin.
...
public:
	...
	/**Generates a proof spending a mmocoin.
	 *
	 ...
	 * @throw MMOCoinException if the process fails
	 */

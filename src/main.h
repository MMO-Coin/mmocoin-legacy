...
// first 1000 blocks - all coinbase of 100000 ea, last 50 are just for 'padding' (just in case)
...
static const int64_t MAX_MONEY = 260000000 * COIN; //Total coin will be relase.
inline bool MoneyRange(int64_t nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp. */
static const unsigned int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC

static const uint256 hashGenesisBlock("0x000006670ae1c3f7712d3d22d4279b4d72d017c065c8c908c14e0d04191b4108");
...
extern libmmocoin::Params* ZCParams;
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge, int64_t& nCoinValue) const;  // ppcoin: get transaction coin age

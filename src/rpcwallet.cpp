...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <mmocoinpubkey>\n"
            "Return information about <mmocoinpubkey>.");
...
// MMOCoin: resend unconfirmed wallet transactions
